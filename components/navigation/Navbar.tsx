          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              <li key={item.id}>
                <Link
                  href={item.href}
                  className={`text-[11px] sm:text-xs font-mono tracking-widest uppercase transition-colors relative py-1 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent ${
                    isActive
                      ? "text-accent"
